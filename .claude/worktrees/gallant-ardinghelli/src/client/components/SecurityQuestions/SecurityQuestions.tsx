...
const SecurityQuestions: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    if (
      ...
      setErrorMessage("Your security answers are incorrect. Please try again or contact our customer support.");
    }
  };
    ...
    <div className="security-questions-container">
      ...
      <form onSubmit={handleSubmit}>
        <div className="security-question">
          <label className="security-question-label">1. What is your first childhood dog's name?</label>
          <input
            type="text"
        ...
        <div className="security-question">
          <label className="security-question-label">2. What's your grandpa from your father's name?</label>
          <input
            type="text"
            className="security-question-input"
            value={grandpaName}
        ...
        <div className="security-question">
          <label className="security-question-label">3. What's the family name of your first grade teacher?</label>
          <input
            type="text"
            className="security-question-input"

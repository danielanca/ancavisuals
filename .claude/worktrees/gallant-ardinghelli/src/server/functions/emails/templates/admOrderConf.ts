...
export const renderAdminTemplate = (cartProd: any, invoiceNumberID: any, data: any, downloadURL?: any) => {
  return (
          ...
          <td class="esdev-mso-td" valign="top" style="padding:0;Margin:0"> 
           <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left"> 
             <tr> 
              ...
              ${
                item.id.includes("mini-album")
                  ? `<tr>
                    <td align="left" style="padding: 0; margin: 0; padding-top: 2px">
                      <p style="margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; font-family: arial, 'helvetica neue', helvetica, sans-serif; line-height: 21px; color: #333333; font-size: 14px">
                        <br><a href="${downloadURL}" style="color: #007BFF; text-decoration: none;">Download Zip</a>
                      </p>
                    </td>
              </tr>`
                  : " "

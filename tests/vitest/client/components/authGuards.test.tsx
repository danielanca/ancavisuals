...
import CheckAuth from "src/client/features/admin/components/CheckAuth";
import RequireAuth from "src/client/features/admin/components/RequireAuth";
...
vi.mock("src/client/components/UI/Loader", () => ({

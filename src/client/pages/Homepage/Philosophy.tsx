      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light">
            There's something magical about film photography that digital just can't replicate. The grain tells stories,
            the colors breathe with life, and the way light dances across each frame creates pure poetry in motion.
          </p>

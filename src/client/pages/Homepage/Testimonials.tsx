    ...
    <section className="py-32 px-6 bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-300 leading-relaxed italic -mt-8">
              Alma captured our wedding day in a way that felt like poetry in motion. Every single image tells a story,
              and the film quality gives them a timeless feel that digital just can't match. When we look at our photos,
              we don't just see what happened—we feel transported back to that exact moment, with all the emotions and
              energy intact. These aren't just photographs; they're heirlooms.
            </p>
            <div className="pt-4">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-300 leading-relaxed italic -mt-8">
              ...
              gallery, but they're also deeply personal and authentic to who we are as a couple. She has this incredible
              ability to make you forget the camera is there, which results in the most genuine, beautiful images. The
              film grain adds such character—these photos will be treasured for generations.
            </p>
            <div className="pt-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center space-y-4">
            <p className="text-gray-300 italic leading-relaxed">
              "The investment in film photography was the best decision we made for our wedding. These images will never
              go out of style, and the quality is something we'll treasure forever."
            </p>
            <div>

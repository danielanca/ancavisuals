        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6 text-base md:text-lg leading-relaxed text-gray-800">
            ...
            <p>
              ...
              replicate—the grain tells stories, the colors breathe with life, and every single frame carries the weight
              of intention because you can't just delete and try again.
            </p>
            <p>
              ...
              authentic moments, you must first live authentically yourself—which means embracing the messy, beautiful,
              imperfect reality of being human.
            </p>
            <p>
              My approach is simple: be present, be patient, and let your story unfold naturally. I'm not here to direct
              your day or pose you into perfection—I'm here to witness the magic that already exists between you and
              transform it into something that will make your heart skip a beat for generations to come.
            </p>
          </div>
        </div>

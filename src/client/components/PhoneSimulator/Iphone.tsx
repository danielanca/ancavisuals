...
const Iphone: React.FC = () => {
  const iconStyle1 = {
    backgroundImage:
      "url(https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fllamadas.png?alt=media&token=24b6d8a0-d111-4e85-bf53-39f23de9145a)",
  };

  const iconStyle2 = {
    backgroundImage:
      "url(https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fsafari.png?alt=media&token=aec77205-ccfe-4b77-ae66-272843db2abe)",
  };

  const iconStyle3 = {
    backgroundImage:
      "url(https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Fwhatsapp.png?alt=media&token=b3416a44-56fc-4991-a10b-e4a34944bf3c)",
  };

  const iconStyle4 = {
    backgroundImage:
      "url(https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ffacebook.png?alt=media&token=f383d17e-32a7-49ef-8ebb-c723d556baa2)",
  };

  const iconStyle5 = {
    backgroundImage:
      "url(https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ffacetime.png?alt=media&token=4c66d073-d44e-4671-878e-6a8dd1dc7956)",
  };
  ...
  const iconStyle10 = {
    backgroundImage:
      "url(https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ftwitter.png?alt=media&token=4360a8ea-afce-4f20-9057-bb2d4d5a9e41)",
  };

  const iconStyle11 = {
    backgroundImage:
      "url(https://firebasestorage.googleapis.com/v0/b/fotos-3cba1.appspot.com/o/ios14%2Ffotos.png?alt=media&token=86d712fd-aab1-48a3-a6d0-f2b5b7f9a2ab)",
  };
      ...
      <section className="iphoneMock">
        <div className="container">
                ...
                <div className="mainScreen bloqueado">
                  ...
                  <div className="widgetCenter hidden">
                    <div className="buscador">
                      <div className="icono"></div>Buscar
                    </div>
                  ...
                  <div className="widgetScreen hidden">
                    <div className="wrapper">
                      <div className="buscador">
                        <div className="icono"></div>Buscar widgets
                      </div>
                    ...
                    <div className="content">
                      ...
                      <div className="actionIcon iconItem lampara">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
                          <path
                            className="filled"
                            d="M117,62.85v13.72c0,32.45,10.64,61.49,27.43,81.57v206.43h109.71V158.14c16.79-20.08,27.43-49.12,27.43-81.57 V62.85H117z M203.37,246.86c0,6.45-10,6.43-10,0v-41.88c0-6.45,10-6.43,10,0V246.86z M259.35,73.33H136.65c-6.45,0-6.43-10,0-10 h122.69C265.79,63.33,265.78,73.33,259.35,73.33z"
                          ></path>
                          <path
                            className="filled"
                            d="M144.43,364.57v13.71c0,7.57,6.14,13.72,13.71,13.72h82.29c7.57,0,13.71-6.15,13.71-13.72v-13.71H144.43z M144.43,364.57"
                          ></path>
                          <path
                            className="filled"
                            d="M267.86,8H130.71C123.14,8,117,14.14,117,21.71v41.14h164.57V21.71C281.57,14.14,275.43,8,267.86,8L267.86,8z M267.86,8"
                          ></path>
          ...
          <div className="interactionInfo hidden">
            ...
            <p>
              Interfaz interactiva del <b>iPhone 12</b> con el nuevo <b>iOS 14.</b>
            </p>
            <p>
              Algunas funciones son interactivas, se agregaron eventos para simular los gestos touch de los celulares,
              por lo pronto solo funciona en PC.
            </p>
            <p className="importante">
              La app de camara muestra su interfaz y muestra el nuevo led indicador de uso de camara y microfono.
            </p>
            <div className="botones">
              <div className="boton botonGirar" data-front="Ver parte trasera" data-back="Ver parte frontal"></div>
              <div
                className="boton botonBloquear"
                data-front="Bloquear pantalla"
                data-back="Desbloquear pantalla"
              ></div>
            </div>
            ...
            <ul>
              ...
              <li>
                Al presionar cualquier parte de la appScreen (que no sea una app) se pasara directo a la edicion de la
                pantalla de inicio
              </li>
              <li>Al presionar una app directamente se muestra el menu de acciones</li>
              <li>
                Se agrego la pantalla para añadir widgets. Aunque no funciona la parte de añadir xD si muestra la
                animación al mostrar la pantalla
              </li>
              <li>
                Los drags de las pantallas si funcionan, la <b>appScreen</b> tiene activado el drag a la izquierda y
                derecha, la <b>adminBar</b> el drag hacia abajo para mostrar el controlCenter, la <b>lockScreen</b> el
                drag hacia arriba para desbloquear el dispositivo
              </li>
            </ul>
          </div>
        </div>

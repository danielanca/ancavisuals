...
function DetectivHacker() {
  return (
    <div style={{ backgroundImage: `url(${images.crima_detectivului.detectivHackerBg})` }} className='bg-cover bg-center '>
    <div className='w-[100%] md:w-[80%] mx-auto flex flex-wrap justify-center items-center py-10 lg:py-32'>
          ...
          <div className='w-[80%] md:w-[30%] flex flex-col items-center md:items-end py-20 px-10 xl:border-r-2'>
              ...
              <p className='text-center md:text-right mb-10'>Intră în pielea unui detectiv hacker, interceptând conversații secrete pentru a descoperi adevărul ascuns</p>
              <div className='text-2xl font-bold px-8 py-2 text-center cursor-pointer text-[#151515] bg-[#FCDB07] hover:bg-[#dcca56] mb-10'>PE TELEFON / DESKTOP</div>
              <p className='text-center md:text-right mb-10'>Vei avea access la panoul de control de detectiv, unde vei primi email si parola de detectiv.</p>

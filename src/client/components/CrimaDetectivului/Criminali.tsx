    ...
    <div style={{ backgroundImage: `url(${images.crima_detectivului.criminaliBg})` }} className='bg-cover bg-center '>
      <div className='w-[100%] md:w-[80%] mx-auto flex flex-wrap justify-center items-center py-10 lg:py-32'>
          ...
          <div className='w-[80%] md:w-[30%] flex flex-col items-center md:items-start py-20 px-10 xl:border-l-2'>
              ...
              <p className='text-center md:text-left mb-10'>Intră în pielea unui detectiv hacker, interceptând conversații secrete pentru a descoperi adevărul ascuns</p>
              ...
              <p className='text-center md:text-left mb-10'>Vei avea access la panoul de control de detectiv, unde vei primi email si parola de detectiv.</p>

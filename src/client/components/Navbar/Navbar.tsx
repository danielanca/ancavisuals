...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 p-4 md:p-8 bg-black/20 backdrop-blur-sm">
            <div className="flex justify-between items-center max-w-7xl mx-auto">
                ...
                >
                    <div className="relative w-6 h-6 flex flex-col justify-center items-center">
                        <span
                            className={`block absolute h-0.5 w-6 bg-white transform transition duration-300 ease-in-out ${isMobileMenuOpen ? "rotate-45" : "-translate-y-1.5"
                                }`}
                        ></span>
                        <span
                            className={`block absolute h-0.5 w-6 bg-white transform transition duration-300 ease-in-out ${isMobileMenuOpen ? "opacity-0" : ""
                                }`}
                        ></span>
                        <span
                            className={`block absolute h-0.5 w-6 bg-white transform transition duration-300 ease-in-out ${isMobileMenuOpen ? "-rotate-45" : "translate-y-1.5"
            ...
            <div
                className={`lg:hidden fixed top-0 left-0 right-0 bottom-0 w-screen h-screen z-40 transition-all duration-500 ease-in-out ${isMobileMenuOpen ? "pointer-events-auto" : "pointer-events-none"
                    }`}
                style={{
            ...
            >
                {/* Menu Content */}
                <div
                    className={`relative h-full flex flex-col justify-between p-6 transform transition-all duration-500 ease-in-out ${isMobileMenuOpen ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                        }`}
                >
                    {/* Header */}
                    <div className="flex justify-between items-start">
                        <div>
                            <h1 className="text-2xl font-light tracking-[0.3em] uppercase text-white mb-1">ANCAVISUALS</h1>

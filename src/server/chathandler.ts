import { ForensicHandler } from "./gameLogic/detectiveChat/forensicHandler";
import { ChatResponse, streamType } from "./gameLogic/detectiveChat/ConversationTypes";
...
const getChatResponse = async (data:streamType): Promise<RESPONSE_TYPE> => {
    ...
    switch (data.departmentId) {
        case 'forensic':
            feedbackMessage = await forensicResponse(data); break;
        // case 'technical':

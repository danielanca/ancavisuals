...
export const conversationMapSecond: Map<ConversationState, ConversationStep[]> = new Map([
  ...
  [ConversationState.GatheringEvidence, [{
    ...
    response: "Ce avem despre acest individ este ca a mai comis diferite fapte in trecut. Ar fi bine sa dai un ochi peste prostiile pe care el le-a mai facut",
    suggestedNextPrompts: ['Ce anume a facut?', 'Mai este cineva implicat?'],
    nextState: ConversationState.DiscussingFindings,
  }]],
  [ConversationState.DiscussingFindings, [{
    triggers: ['Show me the evidence.', 'What evidence is there?'],
    response: "We found a few pieces of evidence. [Details about the evidence]. Based on this, what's your conclusion?",
  ...
  [ConversationState.MakingConclusions, [{
    ...
    response: "Your conclusion has been noted. Our investigation will take your analysis into account. Would you like to investigate another case?",
